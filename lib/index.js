...
exports.LOADING_SUFFIX = '_LOADING';
exports.SUCCESS_SUFFIX = '_SUCCESS';
exports.ERROR_SUFFIX = '_ERROR';
    ...
    Object.keys(types).forEach(function (property) {
        if (fetchActionTypes.hasOwnProperty(property)) {
            ...
            if (fetchActionTypes[property] === exports.NO_ERROR_TYPES) {
                result = [namespace + property + exports.LOADING_SUFFIX, namespace + property + exports.SUCCESS_SUFFIX, null];
            ...
            result = [
                namespace + property + exports.LOADING_SUFFIX,
                namespace + property + exports.SUCCESS_SUFFIX,
                namespace + property + exports.ERROR_SUFFIX
            ];
            result.loading = result[0];
            result.success = result[1];
...
var AsyncTuple = (function () {
    ...
    AsyncTuple.handleAll = function (prefix, state, action, process) {
        ...
        if (action.url && action.type && action.stateKey && action.type.startsWith(prefix)) {
            ...
            var fetchType = '';
            if (actionType.endsWith(exports.LOADING_SUFFIX)) {
                fetchType = 'loading';
            }
            else if (actionType.endsWith(exports.SUCCESS_SUFFIX)) {
                fetchType = 'success';
            }
            else if (actionType.endsWith(exports.ERROR_SUFFIX)) {
                fetchType = 'error';
            }
